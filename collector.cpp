...
Ship CreateHawkMK1()
{
	...
	Biba_ship.AddShipStructInLine(3, Create_block(weapon_block, Biba_ship.Return_group(1), not_advance_block));
	Biba_ship.AddShipStructInLine(3, Create_block(empty_block, Biba_ship.Return_group(0), not_advance_block));
	Biba_ship.AddShipStructInLine(3, Create_block(inside_and_weapon_block, Biba_ship.Return_group(3), outside_and_cabin_block));
	Biba_ship.AddShipStructInLine(3, Create_block(inside_and_weapon_block, Biba_ship.Return_group(3), outside_and_cabin_block));
	Biba_ship.AddShipStructInLine(3, Create_block(empty_block, Biba_ship.Return_group(0), not_advance_block));
	...
	Biba_ship.AddShipStructInLine(4, Create_block(weapon_block, Biba_ship.Return_group(1), not_advance_block));
	Biba_ship.AddShipStructInLine(4, Create_block(empty_block, Biba_ship.Return_group(0), not_advance_block));
	Biba_ship.AddShipStructInLine(4, Create_block(inside_and_weapon_block, Biba_ship.Return_group(3), outside_and_cabin_block));
	Biba_ship.AddShipStructInLine(4, Create_block(inside_and_weapon_block, Biba_ship.Return_group(3), outside_and_cabin_block));
	Biba_ship.AddShipStructInLine(4, Create_block(empty_block, Biba_ship.Return_group(0), not_advance_block));
	...
	Biba_ship.AddShipStructInLine(5, Create_block(inside_and_weapon_block, Biba_ship.Return_group(1), outside_block));
	Biba_ship.AddShipStructInLine(5, Create_block(inside_and_weapon_block, Biba_ship.Return_group(1), outside_block));
	...
	Biba_ship.AddShipStructInLine(5, Create_block(inside_and_weapon_block, Biba_ship.Return_group(2), outside_block));
	Biba_ship.AddShipStructInLine(5, Create_block(inside_and_weapon_block, Biba_ship.Return_group(2), outside_block));
	
	Biba_ship.AddShipStructInLine(6, Create_block(inside_and_weapon_block, Biba_ship.Return_group(1), outside_block));
	Biba_ship.AddShipStructInLine(6, Create_block(inside_block, Biba_ship.Return_group(1), outside_block));
	...
	Biba_ship.AddShipStructInLine(6, Create_block(inside_and_weapon_block, Biba_ship.Return_group(3), cabin_block));
	Biba_ship.AddShipStructInLine(6, Create_block(inside_and_weapon_block, Biba_ship.Return_group(3), cabin_block));
	Biba_ship.AddShipStructInLine(6, Create_block(empty_block, Biba_ship.Return_group(0), not_advance_block));
	Biba_ship.AddShipStructInLine(6, Create_block(inside_block, Biba_ship.Return_group(2), not_advance_block));
	Biba_ship.AddShipStructInLine(6, Create_block(inside_block, Biba_ship.Return_group(2), outside_block));
	Biba_ship.AddShipStructInLine(6, Create_block(inside_and_weapon_block, Biba_ship.Return_group(2), outside_block));
	
	Biba_ship.AddShipStructInLine(7, Create_block(inside_and_weapon_block, Biba_ship.Return_group(1), outside_block));
	Biba_ship.AddShipStructInLine(7, Create_block(inside_block, Biba_ship.Return_group(1), outside_block));
	...
	Biba_ship.AddShipStructInLine(7, Create_block(inside_block, Biba_ship.Return_group(2), outside_block));
	Biba_ship.AddShipStructInLine(7, Create_block(inside_and_weapon_block, Biba_ship.Return_group(2), outside_block));
	
	Biba_ship.AddShipStructInLine(8, Create_block(inside_and_weapon_block, Biba_ship.Return_group(1), outside_block));
	Biba_ship.AddShipStructInLine(8, Create_block(inside_block, Biba_ship.Return_group(1), outside_block));
	...
	Biba_ship.AddShipStructInLine(8, Create_block(inside_block, Biba_ship.Return_group(3), cabin_block));
	Biba_ship.AddShipStructInLine(8, Create_block(inside_block, Biba_ship.Return_group(3), cabin_block));
	Biba_ship.AddShipStructInLine(8, Create_block(empty_block, Biba_ship.Return_group(0), not_advance_block));
	Biba_ship.AddShipStructInLine(8, Create_block(inside_block, Biba_ship.Return_group(2), not_advance_block));
	Biba_ship.AddShipStructInLine(8, Create_block(inside_block, Biba_ship.Return_group(2), outside_block));
	Biba_ship.AddShipStructInLine(8, Create_block(inside_and_weapon_block, Biba_ship.Return_group(2), outside_block));
	
	Biba_ship.AddShipStructInLine(9, Create_block(inside_and_weapon_block, Biba_ship.Return_group(1), outside_block));
	Biba_ship.AddShipStructInLine(9, Create_block(inside_block, Biba_ship.Return_group(1), outside_block));
	...
	Biba_ship.AddShipStructInLine(9, Create_block(inside_block, Biba_ship.Return_group(3), cabin_block));
	Biba_ship.AddShipStructInLine(9, Create_block(inside_block, Biba_ship.Return_group(3), cabin_block));
	Biba_ship.AddShipStructInLine(9, Create_block(empty_block, Biba_ship.Return_group(0), not_advance_block));
	Biba_ship.AddShipStructInLine(9, Create_block(inside_block, Biba_ship.Return_group(2), not_advance_block));
	Biba_ship.AddShipStructInLine(9, Create_block(inside_block, Biba_ship.Return_group(2), outside_block));
	Biba_ship.AddShipStructInLine(9, Create_block(inside_and_weapon_block, Biba_ship.Return_group(2), outside_block));
	
	Biba_ship.AddShipStructInLine(10, Create_block(inside_block, Biba_ship.Return_group(4), outside_block));
	Biba_ship.AddShipStructInLine(10, Create_block(inside_block, Biba_ship.Return_group(4), outside_block));
	...
	Biba_ship.AddShipStructInLine(10, Create_block(inside_block, Biba_ship.Return_group(5), not_advance_block));
	Biba_ship.AddShipStructInLine(10, Create_block(inside_block, Biba_ship.Return_group(5), not_advance_block));
	Biba_ship.AddShipStructInLine(10, Create_block(inside_block, Biba_ship.Return_group(6), outside_block));
	Biba_ship.AddShipStructInLine(10, Create_block(inside_block, Biba_ship.Return_group(6), outside_block));	
	
	Biba_ship.AddShipStructInLine(11, Create_block(inside_block, Biba_ship.Return_group(4), outside_block));
	Biba_ship.AddShipStructInLine(11, Create_block(inside_block, Biba_ship.Return_group(4), outside_block));
	...
	Biba_ship.AddShipStructInLine(11, Create_block(inside_block, Biba_ship.Return_group(5), not_advance_block));
	Biba_ship.AddShipStructInLine(11, Create_block(inside_block, Biba_ship.Return_group(5), not_advance_block));
	Biba_ship.AddShipStructInLine(11, Create_block(inside_block, Biba_ship.Return_group(6), outside_block));
	Biba_ship.AddShipStructInLine(11, Create_block(inside_block, Biba_ship.Return_group(6), outside_block));
	
	Biba_ship.AddShipStructInLine(12, Create_block(inside_block, Biba_ship.Return_group(4), outside_block));
	Biba_ship.AddShipStructInLine(12, Create_block(inside_block, Biba_ship.Return_group(4), outside_block));
	...
	Biba_ship.AddShipStructInLine(12, Create_block(inside_block, Biba_ship.Return_group(5), not_advance_block));
	Biba_ship.AddShipStructInLine(12, Create_block(inside_block, Biba_ship.Return_group(5), not_advance_block));
	Biba_ship.AddShipStructInLine(12, Create_block(inside_block, Biba_ship.Return_group(6), outside_block));
	Biba_ship.AddShipStructInLine(12, Create_block(inside_block, Biba_ship.Return_group(6), outside_block));
	
	Biba_ship.AddShipStructInLine(13, Create_block(inside_and_engine_block, Biba_ship.Return_group(4), outside_block));
	Biba_ship.AddShipStructInLine(13, Create_block(inside_and_engine_block, Biba_ship.Return_group(4), outside_block));
	...
	Biba_ship.AddShipStructInLine(13, Create_block(inside_and_engine_block, Biba_ship.Return_group(6), outside_block));
	Biba_ship.AddShipStructInLine(13, Create_block(inside_and_engine_block, Biba_ship.Return_group(6), outside_block));
	
	Biba_ship.AddShipStructInLine(14, Create_block(inside_and_engine_block, Biba_ship.Return_group(4), outside_block));
	Biba_ship.AddShipStructInLine(14, Create_block(inside_and_engine_block, Biba_ship.Return_group(4), outside_block));
	Biba_ship.AddShipStructInLine(14, Create_block(inside_and_engine_block, Biba_ship.Return_group(4), not_advance_block));
	Biba_ship.AddShipStructInLine(14, Create_block(inside_block, Biba_ship.Return_group(5), gate_block));
	Biba_ship.AddShipStructInLine(14, Create_block(inside_block, Biba_ship.Return_group(5), gate_block));
	Biba_ship.AddShipStructInLine(14, Create_block(inside_block, Biba_ship.Return_group(5), gate_block));
	Biba_ship.AddShipStructInLine(14, Create_block(inside_block, Biba_ship.Return_group(5), gate_block));
	Biba_ship.AddShipStructInLine(14, Create_block(inside_and_engine_block, Biba_ship.Return_group(6), not_advance_block));
	Biba_ship.AddShipStructInLine(14, Create_block(inside_and_engine_block, Biba_ship.Return_group(6), outside_block));
	Biba_ship.AddShipStructInLine(14, Create_block(inside_and_engine_block, Biba_ship.Return_group(6), outside_block));
